...
- Save a full candidate list before selecting PDFs. A prior successful run found 148 candidates, selected 10, uploaded the PDFs, then created both a Markdown index and an online Feishu Doc.
